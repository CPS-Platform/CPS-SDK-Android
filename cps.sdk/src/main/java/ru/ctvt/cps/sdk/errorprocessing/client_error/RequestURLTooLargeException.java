...
public class RequestURLTooLargeException extends ClientError {

    public RequestURLTooLargeException(){
        super(EXCEPTION_STRING_CLIENT_ERROR);
    }

    public RequestURLTooLargeException(String message){
        super(Strings.isNullOrEmpty(message)? EXCEPTION_STRING_CLIENT_ERROR: message);
    }

    public RequestURLTooLargeException(String message, Throwable cause){
        super(Strings.isNullOrEmpty(message)? EXCEPTION_STRING_CLIENT_ERROR: message, cause);
    }

    public RequestURLTooLargeException(Throwable cause){
        super(EXCEPTION_STRING_CLIENT_ERROR, cause);
    }

    public int getResponseCode(){
        return RESPONSE_CODE_REQUEST_URL_TOO_LARGE;
    }
